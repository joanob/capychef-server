...
- [ ] Eliminar espacio de almacenamiento (si no tiene lotes asociados)

## Alimentos
- [ ] Crear, editar y eliminar categorías masivamente
- [ ] Crear, editar y eliminar alimentos globales masivamente
...
- [ ] Crear alimentos
- [ ] Editar alimentos
- [ ] Eliminar alimentos (si no tienen lotes asociados)
...
- [ ] Modificar cantidad mínima de un alimento del hogar
- [ ] Modificar supermercado preferido, precio o impacto ambiental de un alimento del hogar
...
- [ ] Guardar cantidad en espacio de almacenamiento

## Recetas
- [ ] Crear receta
- [ ] Editar información receta
- [ ] Eliminar receta (si no tiene planificaciones asociadas)
