...
(
    ...
    previous_food_uom_id  INTEGER,
    delta_quantity        REAL,
    delta_food_uom_id     INTEGER,
    new_quantity          REAL       NOT NULL,
    new_food_uom_id       INTEGER    NOT NULL,
    best_before_date      DATE,
    expiration_date       DATE,
    created_from_batch_id INTEGER,
    created_new_batch_id  INTEGER,
    created_at            TIMESTAMP  NOT NULL,
    created_by            INTEGER NOT NULL,
    ...
    FOREIGN KEY (created_from_batch_id) REFERENCES batches (id),
    FOREIGN KEY (created_new_batch_id) REFERENCES batches (id),
    FOREIGN KEY (created_by) REFERENCES users (id)
);
